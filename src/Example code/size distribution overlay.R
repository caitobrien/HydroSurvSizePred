    ...
    fluidRow(
      ...
      shinydashboard::box(
        ...
        HTML("
             <div>
             <ul>
             <li><b>Smolt length:</b> The distribution of smolt lengths can be explored across years, months, and half-months through the outmigration season.</li>
             <li><b>Predation risk:</b> The percentages of smolts each year below size thresholds susceptible to fish predation can be viewed.</li>
             ...
             <li><b>Length, predation risk, survival:</b> A comparison between length distributions predation risk, and LWG-BOA survival is available for viewing across years.</li>
             </ul>
             </div>
             ")
      ),
