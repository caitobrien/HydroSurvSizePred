...
**Option 1:** You can install the development version of *HydroSurvSizePred* from [GitHub](https://github.com/) with:
...
**Option 2:** If you are interested in the files that support the development version, please see: [https://github.com/caitobrien/HydroSurvSizePred](https://github.com/caitobrien/HydroSurvSizePred) to clone the repository. Alternatively, within Rstudio, use the following steps: 

1. Start a new project with  `File > New Project > Version Control > Git` 

2. In the repository URL field, paste `https://github.com/caitobrien/HydroSurvSizePred.git`
